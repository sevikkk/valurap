...
FreeCAD.newDocument("left_y_motor_plate")
App.setActiveDocument("left_y_motor_plate")
print(3)
body_body_debug = True
body_body = App.activeDocument().addObject('PartDesign::Body', 'LeftYMotorPlate')
body_body.Label = 'LeftYMotorPlate'
