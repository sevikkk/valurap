module y_motor_corner(is_left) {
    ...
    difference() {
        ...
        translate([-30, 14,-55]) rotate([0,90,0]) cylinder(d=5, h=10);
        translate([-30,34,-55]) rotate([0,90,0]) cylinder(d=5, h=10);
        translate([-30,34,-25]) rotate([0,90,0]) cylinder(d=5, h=10);
        translate([-30,34, 17]) rotate([0,90,0]) cylinder(d=5, h=10);
        translate([-30, 14, 17]) rotate([0,90,0]) cylinder(d=5, h=10);
