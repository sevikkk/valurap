...
def test_solve_model_1():
    ...
    assert res == {
        ...
        "accel_j": 0,
        "accel_jj": 0,
        "accel_middle_x": 17.600000004414085,
        "accel_t": 23,
        "accel_x": 35.20000000882817,
        "e_delta_v": -7.354537956416607e-06,
        "e_jerk": -7.62939453125e-05,
        "e_target": -14.93333312923005,
        "plato_t": 2487,
