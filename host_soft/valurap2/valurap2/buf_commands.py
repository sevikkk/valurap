...
class CommandBuffer(object):
    ...
    IN_BE_STATUS_WAITING_FOR_DATA = (IN_BE_STATUS, 2)
    IN_BE_STATUS_WAITING_FOR_INT = (IN_BE_STATUS, 3)
    IN_BE_STATUS_ABORTED = (IN_BE_STATUS, 4)
    IN_BE_STATUS_BUFFER_UNDERRUN = (IN_BE_STATUS, 5)
    IN_BE_STATUS_BAD_CODE = (IN_BE_STATUS, 6)
    IN_APG_STATUS = 1
    IN_ES_STATUS = 2
